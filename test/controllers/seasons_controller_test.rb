...
class SeasonsControllerTest < ActionController::TestCase
  ...
  test "should create season" do
    assert_difference('Season.count') do
      post :create, season: { description: @season.description, image_path: @season.image_path, season_number: @season.season_number }
    end
  ...
  test "should update season" do
    patch :update, id: @season, season: { description: @season.description, image_path: @season.image_path, season_number: @season.season_number }
    assert_redirected_to season_path(assigns(:season))
  end
