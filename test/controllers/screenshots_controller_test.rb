...
class ScreenshotsControllerTest < ActionController::TestCase
  ...
  test "should create screenshot" do
    assert_difference('Screenshot.count') do
      post :create, screenshot: { episode_number: @screenshot.episode_number, season: @screenshot.season, time_end: @screenshot.time_end, time_start: @screenshot.time_start }
    end
  ...
  test "should update screenshot" do
    patch :update, id: @screenshot, screenshot: { episode_number: @screenshot.episode_number, season: @screenshot.season, time_end: @screenshot.time_end, time_start: @screenshot.time_start }
    assert_redirected_to screenshot_path(assigns(:screenshot))
  end
